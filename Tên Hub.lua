...
spawn(function()
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {Title = "Auto Farm Chất kì dị ", Default = false })
...
ToggleAutoW:OnChanged(function(Value)
 ...
 Tabs.Main:AddParagraph({
    Title = "đảo bí ẩn ",
    Content = "Auto triệu hồi đảo bí ẩn"
})
 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
	...
	spawn(function()
        ...
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Auto Farm nhà máy", Default = false })
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "Tự lưu trữ trái", Default = false })
